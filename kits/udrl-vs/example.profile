set sleeptime "3000"; # saves waiting for beacon to checkin

stage {
    set cleanup "true"; # not explicitly required, can help when reviewing allocated memory as part of testing Release build
}
